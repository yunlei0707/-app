...
export function StatsPage({ onOpenCapsules }) {
    ...
    >
      ...
      <header className="bg-gradient-to-b from-primary-400 to-primary-500 text-white safe-top">
        <div className="px-4 pt-4 pb-6">
          <h1 className="text-xl font-bold mb-4">📊 成长数据</h1>
      ...
      <main className="px-4 -mt-4 space-y-4 max-w-lg mx-auto">
        ...
        <div className="card animate-fade-in">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-cream-50 dark:bg-gray-700 rounded-xl p-4 text-center">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-500 w-8">{stats.photoMoments}</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-500 w-8">{stats.videoMoments}</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-500 w-8">{stats.diaryMoments}</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-500 w-8">{stats.audioMoments}</span>
              </div>
            </div>
          </div>
        </div>
